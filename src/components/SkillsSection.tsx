...
const skills = {
  bahasa : [
    { name: 'bahasa indonesia', level: 94 },
    { name: 'bahasa inggris', level: 98 },
    { name: 'bahasa arab', level: 90 },
    { name: 'bahasa jepang', level: 85 },
  ],
  IPS: [
    { name: 'sosiolagi', level: 90 },
    { name: 'geografi', level: 88 },
    { name: 'ekonomi', level: 97 },
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          ...
          >
            <div className="flex items-center gap-3 mb-6">
              ...
              <h3 className="font-display text-xl font-bold">IPA &amp; Lainnya</h3>
            </div>
            <div className="space-y-4">
